...
struct pilote_status {
    bool locked;               // Prevent a process from reading when another is writing
	float current_time;        // Value set before an event is fired
	int current_sector;        // Value set before an event is fired
